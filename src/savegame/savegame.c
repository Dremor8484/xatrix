...
InitGame(void)
{
	...
	cs_player_ammo_magslug = gi.cvar("cs_player_ammo_magslug", "50", CVAR_ARCHIVE);
	cs_player_ammo_trap = gi.cvar("cs_player_ammo_trap", "5", CVAR_ARCHIVE);
	...
	cs_bandolier_ammo_magslug = gi.cvar("cs_bandolier_ammo_magslug", "75", CVAR_ARCHIVE);
	...
	cs_ammopack_ammo_magslug = gi.cvar("cs_ammopack_ammo_magslug", "100", CVAR_ARCHIVE);
	cs_ammopack_ammo_trap = gi.cvar("cs_ammopack_ammo_trap", "5", CVAR_ARCHIVE);
	...
	cs_quadfire_duration = gi.cvar("cs_quadfire_duration", "300", CVAR_ARCHIVE);
	
	cs_health_food_val = gi.cvar("cs_health_food_val", "0", CVAR_ARCHIVE);
	...
	cs_weapon_ionripper_damage_sp = gi.cvar("cs_weapon_ionripper_damage_sp", "50", CVAR_ARCHIVE);
	cs_weapon_ionripper_damage_mp = gi.cvar("cs_weapon_ionripper_damage_mp", "30", CVAR_ARCHIVE);
	cs_weapon_ionripper_speed = gi.cvar("cs_weapon_ionripper_speed", "500", CVAR_ARCHIVE);
	...
	cs_weapon_phalanx_damage_direct = gi.cvar("cs_weapon_phalanx_damage_direct", "80", CVAR_ARCHIVE);
	cs_weapon_phalanx_damage_radius = gi.cvar("cs_weapon_phalanx_damage_radius", "30", CVAR_ARCHIVE);
	cs_weapon_phalanx_radius = gi.cvar("cs_weapon_phalanx_radius", "120", CVAR_ARCHIVE);
	cs_weapon_phalanx_speed = gi.cvar("cs_weapon_phalanx_speed", "725", CVAR_ARCHIVE);
	cs_weapon_phalanx_yaw = gi.cvar("cs_weapon_phalanx_yaw", "1.5", CVAR_ARCHIVE);
	cs_weapon_phalanx_use_two_ammo = gi.cvar("cs_weapon_phalanx_use_two_ammo", "0", CVAR_ARCHIVE);
	cs_weapon_phalanx_heat_seeker = gi.cvar("cs_weapon_phalanx_heat_seeker", "0", CVAR_ARCHIVE);
	cs_weapon_phalanx_heat_range = gi.cvar("cs_weapon_phalanx_heat_range", "128", CVAR_ARCHIVE);
	...
	cs_weapon_trap_len_max = gi.cvar("cs_weapon_trap_len_max", "8000", CVAR_ARCHIVE);
	cs_weapon_trap_len_min = gi.cvar("cs_weapon_trap_len_min", "32", CVAR_ARCHIVE);
	cs_weapon_trap_search_radius = gi.cvar("cs_weapon_trap_search_radius", "256", CVAR_ARCHIVE);
