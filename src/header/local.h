...
extern cvar_t *cs_player_ammo_magslug;
extern cvar_t *cs_player_ammo_trap;
...
extern cvar_t *cs_bandolier_ammo_magslug;
...
extern cvar_t *cs_ammopack_ammo_magslug;
extern cvar_t *cs_ammopack_ammo_trap;
...
extern cvar_t *cs_quadfire_duration;

extern cvar_t *cs_health_food_val;
...
extern cvar_t *cs_weapon_ionripper_damage_sp;
extern cvar_t *cs_weapon_ionripper_damage_mp;
extern cvar_t *cs_weapon_ionripper_speed;
...
extern cvar_t *cs_weapon_phalanx_damage_direct;
extern cvar_t *cs_weapon_phalanx_damage_radius;
extern cvar_t *cs_weapon_phalanx_radius;
extern cvar_t *cs_weapon_phalanx_speed;
extern cvar_t *cs_weapon_phalanx_yaw;
extern cvar_t *cs_weapon_phalanx_use_two_ammo;
extern cvar_t *cs_weapon_phalanx_heat_seeker;
extern cvar_t *cs_weapon_phalanx_heat_range;
...
extern cvar_t *cs_weapon_trap_len_max;
extern cvar_t *cs_weapon_trap_len_min;
extern cvar_t *cs_weapon_trap_search_radius;
...
void fire_plasma(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed,
		float damage_radius, int radius_damage);
void fire_plasmaheat(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed,
		float damage_radius, int radius_damage);
