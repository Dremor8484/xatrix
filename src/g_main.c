...
cvar_t *cs_player_ammo_magslug;
cvar_t *cs_player_ammo_trap;
...
cvar_t *cs_bandolier_ammo_magslug;
...
cvar_t *cs_ammopack_ammo_magslug;
cvar_t *cs_ammopack_ammo_trap;
...
cvar_t *cs_quadfire_duration;

cvar_t *cs_health_food_val;
...
cvar_t *cs_weapon_ionripper_damage_sp;
cvar_t *cs_weapon_ionripper_damage_mp;
cvar_t *cs_weapon_ionripper_speed;
...
cvar_t *cs_weapon_phalanx_damage_direct;
cvar_t *cs_weapon_phalanx_damage_radius;
cvar_t *cs_weapon_phalanx_radius;
cvar_t *cs_weapon_phalanx_speed;
cvar_t *cs_weapon_phalanx_yaw;
cvar_t *cs_weapon_phalanx_use_two_ammo;
cvar_t *cs_weapon_phalanx_heat_seeker;
cvar_t *cs_weapon_phalanx_heat_range;
...
cvar_t *cs_weapon_trap_len_max;
cvar_t *cs_weapon_trap_len_min;
cvar_t *cs_weapon_trap_search_radius;
